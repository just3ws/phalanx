 ...
 */
export function isValidTarget(_opponentBattlefield, targetColumn) {
 ...
 */
export function getBaseAttackDamage(attacker) {
 ...
 */
function resolveColumnOverflow(baseDamage, attacker, battlefield, column, defenderLp, attackerIsAce) {
 ...
 */
function absorbDamage(card, incomingDamage, attackerIsAce, isFrontRow) {
 ...
 */
export function resetColumnHp(battlefield, column) {
    const newBf = [...battlefield];
    const frontIdx = column;
    const backIdx = column + 4;
    const frontCard = newBf[frontIdx];
 ...
 */
export function resolveAttack(state, attackerPlayerIndex, attackerGridIndex, _targetGridIndex) {
    ...
    const result = resolveColumnOverflow(baseDamage, attacker, defender.battlefield, targetColumn, defender.lifepoints, attackerIsAce);
